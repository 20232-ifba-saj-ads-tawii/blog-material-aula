import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as n,c as t,f as u,a as e,b as a,d as r,e as m}from"./app-7ffdb239.js";const d={},l=m(`<h1 id="git-conceitos-basicos" tabindex="-1"><a class="header-anchor" href="#git-conceitos-basicos" aria-hidden="true">#</a> Git conceitos basicos</h1><p><sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1"></a></sup><br><sup class="footnote-ref"><a href="#footnote2">[2]</a><a class="footnote-anchor" id="footnote-ref2"></a></sup></p><p>O Git é um sistema de controle de versão distribuído amplamente utilizado para rastrear alterações em projetos de software. Ele permite que várias pessoas trabalhem em um projeto simultaneamente, registre todas as alterações feitas e facilite a colaboração e o gerenciamento de código-fonte. Aqui estão alguns conceitos básicos do Git:</p><h2 id="repositorio" tabindex="-1"><a class="header-anchor" href="#repositorio" aria-hidden="true">#</a> Repositório</h2><p>Um repositório Git é um diretório onde o código-fonte e os arquivos relacionados são armazenados. Ele contém todo o histórico de alterações feitas no projeto.</p><p>Para iniciar um repositório:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> init
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="clone" tabindex="-1"><a class="header-anchor" href="#clone" aria-hidden="true">#</a> Clone</h2><p>O clone é o processo de criação de uma cópia local de um repositório remoto. Isso permite que você obtenha uma cópia completa do projeto em seu computador e trabalhe com ele.</p><h2 id="commit" tabindex="-1"><a class="header-anchor" href="#commit" aria-hidden="true">#</a> Commit</h2><p>Um commit é uma operação fundamental no Git, que registra uma ou mais alterações no repositório. Cada commit tem uma mensagem associada que descreve as alterações feitas. Os commits permitem rastrear quem fez quais alterações e quando elas ocorreram.</p><h1 id="merge-mesclar" tabindex="-1"><a class="header-anchor" href="#merge-mesclar" aria-hidden="true">#</a> Merge (mesclar)</h1><p>O merge é o processo de combinar as alterações de um branch a outro. Quando você deseja incorporar as alterações de um branch secundário de volta ao branch principal, você realiza um merge. O Git tenta combinar automaticamente as alterações, mas pode ocorrer conflitos se as mesmas partes do código forem modificadas em ambos os branches. Nesse caso, é necessário resolver manualmente os conflitos.</p><h2 id="branch-ramo" tabindex="-1"><a class="header-anchor" href="#branch-ramo" aria-hidden="true">#</a> Branch (ramo)</h2><p>Um branch é uma linha de desenvolvimento separada dentro de um repositório. Ele permite que você crie e trabalhe em uma versão isolada do projeto sem afetar a linha principal de desenvolvimento (geralmente chamada de &quot;branch master&quot; ou &quot;branch principal&quot;). Os branches são úteis para adicionar novos recursos, corrigir bugs ou experimentar ideias sem comprometer o código estável.</p><h2 id="pull-request" tabindex="-1"><a class="header-anchor" href="#pull-request" aria-hidden="true">#</a> Pull Request</h2><p>Uma Pull Request (PR) é uma solicitação para mesclar as alterações de um branch em outro branch. É uma prática comum em projetos colaborativos, onde um desenvolvedor solicita que outras pessoas revisem e aprovem suas alterações antes de mesclá-las ao branch principal. As PRs fornecem um local centralizado para revisão e discussão do código.</p><h2 id="remote" tabindex="-1"><a class="header-anchor" href="#remote" aria-hidden="true">#</a> Remote</h2><p>O repositório remoto é uma cópia do seu repositório local, hospedada em um servidor. Ele permite que você compartilhe seu código com outras pessoas e colaboradores. O Git fornece comandos para clonar um repositório remoto para seu ambiente local e sincronizar suas alterações com o repositório remoto.</p><h2 id="fork" tabindex="-1"><a class="header-anchor" href="#fork" aria-hidden="true">#</a> Fork</h2><p>Um fork é uma cópia independente de um repositório Git. É uma funcionalidade que permite a criação de um novo repositório a partir de outro existente. Ao fazer um fork, você cria uma cópia completa do repositório original, incluindo todo o histórico de commits.</p><p>O fork é frequentemente usado quando você deseja contribuir para um projeto de código aberto ou colaborar com outros desenvolvedores. Ao fazer um fork de um repositório, você cria sua própria cópia onde pode fazer alterações sem afetar o projeto original. Isso permite que você experimente, faça melhorias ou corrija bugs em seu próprio repositório fork.</p><p>Depois de fazer as alterações em seu repositório fork, você pode enviar uma Pull Request para o repositório original. Uma Pull Request é uma solicitação para que as alterações feitas no seu repositório sejam consideradas para incorporação ao projeto original. Os mantenedores do projeto original podem revisar suas alterações, discutir e decidir se desejam mesclá-las ao repositório principal.</p><p>Os forks são especialmente úteis em projetos de código aberto, onde várias pessoas podem contribuir simultaneamente sem precisar de acesso direto ao repositório principal. Isso ajuda a manter o controle sobre o código-fonte do projeto original, enquanto permite a contribuição de uma ampla comunidade de desenvolvedores.</p>`,24),c=e("hr",{class:"footnotes-sep"},null,-1),p={class:"footnotes"},f={class:"footnotes-list"},v={id:"footnote1",class:"footnote-item"},h={href:"https://www.hostinger.com.br/tutoriais/tutorial-do-git-basics-introducao",target:"_blank",rel:"noopener noreferrer"},b=e("a",{href:"#footnote-ref1",class:"footnote-backref"},"↩︎",-1),q={id:"footnote2",class:"footnote-item"},g={href:"https://dev.to/leandronsp/pt-br-fundamentos-do-git-um-guia-completo-2djh",target:"_blank",rel:"noopener noreferrer"},x=e("a",{href:"#footnote-ref2",class:"footnote-backref"},"↩︎",-1);function z(j,w){const o=i("ExternalLinkIcon");return n(),t("div",null,[l,u(` 
...
`),c,e("section",p,[e("ol",f,[e("li",v,[e("p",null,[a("GIT Tutorial Para Iniciantes "),e("a",h,[a("https://www.hostinger.com.br/tutoriais/tutorial-do-git-basics-introducao"),r(o)]),a(),b])]),e("li",q,[e("p",null,[a("Fundamentos do Git, um guia completo "),e("a",g,[a("https://dev.to/leandronsp/pt-br-fundamentos-do-git-um-guia-completo-2djh"),r(o)]),a(),x])])])])])}const y=s(d,[["render",z],["__file","03_git.html.vue"]]);export{y as default};
